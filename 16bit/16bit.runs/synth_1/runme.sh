...
HD_PWD='D:/practice files/16bit/16bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_XOR_PUF_Top_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basys3_XOR_PUF_Top_16bit.tcl
