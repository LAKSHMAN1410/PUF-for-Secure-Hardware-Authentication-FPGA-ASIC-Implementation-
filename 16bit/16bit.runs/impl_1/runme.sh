...
HD_PWD='D:/practice files/16bit/16bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_XOR_PUF_Top_16bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Basys3_XOR_PUF_Top_16bit.tcl -notrace
