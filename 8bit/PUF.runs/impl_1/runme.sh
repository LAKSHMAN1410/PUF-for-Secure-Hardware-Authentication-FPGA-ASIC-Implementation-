...
HD_PWD='C:/Users/BHARATHI/Downloads/8bit/PUF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_XOR_PUF_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Basys3_XOR_PUF_Top.tcl -notrace
