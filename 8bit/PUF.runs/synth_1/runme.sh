...
HD_PWD='C:/Users/BHARATHI/Downloads/8bit/PUF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_XOR_PUF_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basys3_XOR_PUF_Top.tcl
